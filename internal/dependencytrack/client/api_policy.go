...
func (r ApiGetPoliciesRequest) PageNumber(pageNumber interface{}) ApiGetPoliciesRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetPoliciesRequest) PageSize(pageSize interface{}) ApiGetPoliciesRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetPoliciesRequest) Offset(offset interface{}) ApiGetPoliciesRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetPoliciesRequest) Limit(limit interface{}) ApiGetPoliciesRequest {
	r.limit = &limit
	return r
}
