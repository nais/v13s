...
func (r ApiGetLicensesRequest) PageNumber(pageNumber interface{}) ApiGetLicensesRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetLicensesRequest) PageSize(pageSize interface{}) ApiGetLicensesRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetLicensesRequest) Offset(offset interface{}) ApiGetLicensesRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetLicensesRequest) Limit(limit interface{}) ApiGetLicensesRequest {
	r.limit = &limit
	return r
}
