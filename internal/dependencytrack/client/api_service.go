...
func (r ApiCreateServiceRequest) Body(body ServiceComponent) ApiCreateServiceRequest {
	r.body = &body
	return r
}
...
func (r ApiGetAllServicesRequest) PageNumber(pageNumber interface{}) ApiGetAllServicesRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetAllServicesRequest) PageSize(pageSize interface{}) ApiGetAllServicesRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetAllServicesRequest) Offset(offset interface{}) ApiGetAllServicesRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetAllServicesRequest) Limit(limit interface{}) ApiGetAllServicesRequest {
	r.limit = &limit
	return r
}
...
func (r ApiUpdateServiceRequest) Body(body ServiceComponent) ApiUpdateServiceRequest {
	r.body = &body
	return r
}
