...
*BadgeAPI* | [**GetProjectVulnerabilitiesBadge**](docs/BadgeAPI.md#getprojectvulnerabilitiesbadge) | **Get** /v1/badge/vulns/project/{name}/{version} | Returns current metrics for a specific project
*BadgeAPI* | [**GetProjectVulnerabilitiesBadge1**](docs/BadgeAPI.md#getprojectvulnerabilitiesbadge1) | **Get** /v1/badge/vulns/project/{uuid} | Returns current metrics for a specific project
...
*ComponentPropertyAPI* | [**GetProperties**](docs/ComponentPropertyAPI.md#getproperties) | **Get** /v1/component/{uuid}/property | Returns a list of all ComponentProperties for the specified component
...
*FindingAPI* | [**GetAllFindings**](docs/FindingAPI.md#getallfindings) | **Get** /v1/finding | Returns a list of all findings
*FindingAPI* | [**GetAllFindings1**](docs/FindingAPI.md#getallfindings1) | **Get** /v1/finding/grouped | Returns a list of all findings grouped by vulnerability
...
*LdapAPI* | [**RetrieveLdapGroups**](docs/LdapAPI.md#retrieveldapgroups) | **Get** /v1/ldap/team/{uuid} | Returns the DNs of all groups mapped to the specified team
*LdapAPI* | [**RetrieveLdapGroups1**](docs/LdapAPI.md#retrieveldapgroups1) | **Get** /v1/ldap/groups | Returns the DNs of all accessible groups within the directory
...
*TeamAPI* | [**UpdateApiKeyComment**](docs/TeamAPI.md#updateapikeycomment) | **Post** /v1/team/key/{key}/comment | Updates an API key&#39;s comment
