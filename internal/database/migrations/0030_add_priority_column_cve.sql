...
ALTER TABLE vulnerability_summary
    ...
    ADD COLUMN IF NOT EXISTS priority_elevated INT NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS priority_monitor INT NOT NULL DEFAULT 0;

-- +goose Down
ALTER TABLE vulnerability_summary
    DROP COLUMN IF EXISTS priority_act_now,
    DROP COLUMN IF EXISTS priority_high,
    DROP COLUMN IF EXISTS priority_elevated,
    DROP COLUMN IF EXISTS priority_monitor;
