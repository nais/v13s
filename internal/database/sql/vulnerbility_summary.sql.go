...
VALUES (
    ...
    $8)
RETURNING
    id, image_name, image_tag, critical, high, medium, low, unassigned, risk_score, created_at, updated_at, act_now, high_risk, elevated_risk, monitor, kev_count, ransomware_count, high_epss_count, top_risk_tier
`
