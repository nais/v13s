...
// MarkWorkloadsWithUntrackedImages provides a mock function with given fields: ctx
func (_m *MockQuerier) MarkWorkloadsWithUntrackedImages(ctx context.Context) (int64, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for MarkWorkloadsWithUntrackedImages")
	}
...
// MockQuerier_MarkWorkloadsWithUntrackedImages_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'MarkWorkloadsWithUntrackedImages'
type MockQuerier_MarkWorkloadsWithUntrackedImages_Call struct {
	*mock.Call
}

// MarkWorkloadsWithUntrackedImages is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockQuerier_Expecter) MarkWorkloadsWithUntrackedImages(ctx interface{}) *MockQuerier_MarkWorkloadsWithUntrackedImages_Call {
	return &MockQuerier_MarkWorkloadsWithUntrackedImages_Call{Call: _e.mock.On("MarkWorkloadsWithUntrackedImages", ctx)}
}

func (_c *MockQuerier_MarkWorkloadsWithUntrackedImages_Call) Run(run func(ctx context.Context)) *MockQuerier_MarkWorkloadsWithUntrackedImages_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockQuerier_MarkWorkloadsWithUntrackedImages_Call) Return(_a0 int64, _a1 error) *MockQuerier_MarkWorkloadsWithUntrackedImages_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockQuerier_MarkWorkloadsWithUntrackedImages_Call) RunAndReturn(run func(context.Context) (int64, error)) *MockQuerier_MarkWorkloadsWithUntrackedImages_Call {
	_c.Call.Return(run)
	return _c
}
