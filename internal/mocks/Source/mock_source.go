...
import (
	...
	model "github.com/nais/v13s/internal/model"
...
// UpdateSuppressedVulnerabilities provides a mock function with given fields: ctx, suppressed
func (_m *MockSource) UpdateSuppressedVulnerabilities(ctx context.Context, suppressed []*sources.SuppressedVulnerability) (model.EventTokens, error) {
	ret := _m.Called(ctx, suppressed)

	if len(ret) == 0 {
		panic("no return value specified for UpdateSuppressedVulnerabilities")
	}

	var r0 model.EventTokens
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []*sources.SuppressedVulnerability) (model.EventTokens, error)); ok {
		return rf(ctx, suppressed)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []*sources.SuppressedVulnerability) model.EventTokens); ok {
		r0 = rf(ctx, suppressed)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(model.EventTokens)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, []*sources.SuppressedVulnerability) error); ok {
		r1 = rf(ctx, suppressed)
	} else {
		r1 = ret.Error(1)
	}
...
// MockSource_UpdateSuppressedVulnerabilities_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateSuppressedVulnerabilities'
type MockSource_UpdateSuppressedVulnerabilities_Call struct {
	*mock.Call
}

// UpdateSuppressedVulnerabilities is a helper method to define mock.On call
//   - ctx context.Context
//   - suppressed []*sources.SuppressedVulnerability
func (_e *MockSource_Expecter) UpdateSuppressedVulnerabilities(ctx interface{}, suppressed interface{}) *MockSource_UpdateSuppressedVulnerabilities_Call {
	return &MockSource_UpdateSuppressedVulnerabilities_Call{Call: _e.mock.On("UpdateSuppressedVulnerabilities", ctx, suppressed)}
}

func (_c *MockSource_UpdateSuppressedVulnerabilities_Call) Run(run func(ctx context.Context, suppressed []*sources.SuppressedVulnerability)) *MockSource_UpdateSuppressedVulnerabilities_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]*sources.SuppressedVulnerability))
	})
	return _c
...
func (_c *MockSource_UpdateSuppressedVulnerabilities_Call) Return(_a0 model.EventTokens, _a1 error) *MockSource_UpdateSuppressedVulnerabilities_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSource_UpdateSuppressedVulnerabilities_Call) RunAndReturn(run func(context.Context, []*sources.SuppressedVulnerability) (model.EventTokens, error)) *MockSource_UpdateSuppressedVulnerabilities_Call {
	_c.Call.Return(run)
	return _c
}
