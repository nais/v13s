...
// SuppressVulnerabilityForNamespace provides a mock function with given fields: _a0, _a1
func (_m *MockVulnerabilitiesServer) SuppressVulnerabilityForNamespace(_a0 context.Context, _a1 *vulnerabilities.SuppressVulnerabilityForNamespaceRequest) (*vulnerabilities.SuppressVulnerabilityForNamespaceResponse, error) {
	ret := _m.Called(_a0, _a1)

	if len(ret) == 0 {
		panic("no return value specified for SuppressVulnerabilityForNamespace")
	}

	var r0 *vulnerabilities.SuppressVulnerabilityForNamespaceResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *vulnerabilities.SuppressVulnerabilityForNamespaceRequest) (*vulnerabilities.SuppressVulnerabilityForNamespaceResponse, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *vulnerabilities.SuppressVulnerabilityForNamespaceRequest) *vulnerabilities.SuppressVulnerabilityForNamespaceResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*vulnerabilities.SuppressVulnerabilityForNamespaceResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *vulnerabilities.SuppressVulnerabilityForNamespaceRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// MockVulnerabilitiesServer_SuppressVulnerabilityForNamespace_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SuppressVulnerabilityForNamespace'
type MockVulnerabilitiesServer_SuppressVulnerabilityForNamespace_Call struct {
	*mock.Call
}

// SuppressVulnerabilityForNamespace is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 *vulnerabilities.SuppressVulnerabilityForNamespaceRequest
func (_e *MockVulnerabilitiesServer_Expecter) SuppressVulnerabilityForNamespace(_a0 interface{}, _a1 interface{}) *MockVulnerabilitiesServer_SuppressVulnerabilityForNamespace_Call {
	return &MockVulnerabilitiesServer_SuppressVulnerabilityForNamespace_Call{Call: _e.mock.On("SuppressVulnerabilityForNamespace", _a0, _a1)}
}

func (_c *MockVulnerabilitiesServer_SuppressVulnerabilityForNamespace_Call) Run(run func(_a0 context.Context, _a1 *vulnerabilities.SuppressVulnerabilityForNamespaceRequest)) *MockVulnerabilitiesServer_SuppressVulnerabilityForNamespace_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*vulnerabilities.SuppressVulnerabilityForNamespaceRequest))
	})
	return _c
}

func (_c *MockVulnerabilitiesServer_SuppressVulnerabilityForNamespace_Call) Return(_a0 *vulnerabilities.SuppressVulnerabilityForNamespaceResponse, _a1 error) *MockVulnerabilitiesServer_SuppressVulnerabilityForNamespace_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVulnerabilitiesServer_SuppressVulnerabilityForNamespace_Call) RunAndReturn(run func(context.Context, *vulnerabilities.SuppressVulnerabilityForNamespaceRequest) (*vulnerabilities.SuppressVulnerabilityForNamespaceResponse, error)) *MockVulnerabilitiesServer_SuppressVulnerabilityForNamespace_Call {
	_c.Call.Return(run)
	return _c
}
