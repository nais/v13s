...
// SuppressVulnerabilities provides a mock function with given fields: _a0, _a1
func (_m *MockVulnerabilitiesServer) SuppressVulnerabilities(_a0 context.Context, _a1 *vulnerabilities.SuppressVulnerabilitiesRequest) (*vulnerabilities.SuppressVulnerabilitiesResponse, error) {
	ret := _m.Called(_a0, _a1)

	if len(ret) == 0 {
		panic("no return value specified for SuppressVulnerabilities")
	}

	var r0 *vulnerabilities.SuppressVulnerabilitiesResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *vulnerabilities.SuppressVulnerabilitiesRequest) (*vulnerabilities.SuppressVulnerabilitiesResponse, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *vulnerabilities.SuppressVulnerabilitiesRequest) *vulnerabilities.SuppressVulnerabilitiesResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*vulnerabilities.SuppressVulnerabilitiesResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *vulnerabilities.SuppressVulnerabilitiesRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// MockVulnerabilitiesServer_SuppressVulnerabilities_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SuppressVulnerabilities'
type MockVulnerabilitiesServer_SuppressVulnerabilities_Call struct {
	*mock.Call
}

// SuppressVulnerabilities is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 *vulnerabilities.SuppressVulnerabilitiesRequest
func (_e *MockVulnerabilitiesServer_Expecter) SuppressVulnerabilities(_a0 interface{}, _a1 interface{}) *MockVulnerabilitiesServer_SuppressVulnerabilities_Call {
	return &MockVulnerabilitiesServer_SuppressVulnerabilities_Call{Call: _e.mock.On("SuppressVulnerabilities", _a0, _a1)}
}

func (_c *MockVulnerabilitiesServer_SuppressVulnerabilities_Call) Run(run func(_a0 context.Context, _a1 *vulnerabilities.SuppressVulnerabilitiesRequest)) *MockVulnerabilitiesServer_SuppressVulnerabilities_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*vulnerabilities.SuppressVulnerabilitiesRequest))
	})
	return _c
}

func (_c *MockVulnerabilitiesServer_SuppressVulnerabilities_Call) Return(_a0 *vulnerabilities.SuppressVulnerabilitiesResponse, _a1 error) *MockVulnerabilitiesServer_SuppressVulnerabilities_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVulnerabilitiesServer_SuppressVulnerabilities_Call) RunAndReturn(run func(context.Context, *vulnerabilities.SuppressVulnerabilitiesRequest) (*vulnerabilities.SuppressVulnerabilitiesResponse, error)) *MockVulnerabilitiesServer_SuppressVulnerabilities_Call {
	_c.Call.Return(run)
	return _c
}
