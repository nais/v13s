...
func (r ApiGetViolationsRequest) PageNumber(pageNumber interface{}) ApiGetViolationsRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetViolationsRequest) PageSize(pageSize interface{}) ApiGetViolationsRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetViolationsRequest) Offset(offset interface{}) ApiGetViolationsRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetViolationsRequest) Limit(limit interface{}) ApiGetViolationsRequest {
	r.limit = &limit
	return r
}
...
// The page to return. To be used in conjunction with &lt;code&gt;pageSize&lt;/code&gt;.
func (r ApiGetViolationsByComponentRequest) PageNumber(pageNumber interface{}) ApiGetViolationsByComponentRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetViolationsByComponentRequest) PageSize(pageSize interface{}) ApiGetViolationsByComponentRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetViolationsByComponentRequest) Offset(offset interface{}) ApiGetViolationsByComponentRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetViolationsByComponentRequest) Limit(limit interface{}) ApiGetViolationsByComponentRequest {
	r.limit = &limit
	return r
}
...
// The page to return. To be used in conjunction with &lt;code&gt;pageSize&lt;/code&gt;.
func (r ApiGetViolationsByProjectRequest) PageNumber(pageNumber interface{}) ApiGetViolationsByProjectRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetViolationsByProjectRequest) PageSize(pageSize interface{}) ApiGetViolationsByProjectRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetViolationsByProjectRequest) Offset(offset interface{}) ApiGetViolationsByProjectRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetViolationsByProjectRequest) Limit(limit interface{}) ApiGetViolationsByProjectRequest {
	r.limit = &limit
	return r
}
