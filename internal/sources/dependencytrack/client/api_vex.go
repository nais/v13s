...
func (r ApiUploadVexRequest) ProjectName(projectName string) ApiUploadVexRequest {
	r.projectName = &projectName
	return r
}

func (r ApiUploadVexRequest) ProjectVersion(projectVersion string) ApiUploadVexRequest {
	r.projectVersion = &projectVersion
	return r
}

func (r ApiUploadVexRequest) Vex(vex string) ApiUploadVexRequest {
	r.vex = &vex
	return r
}

func (r ApiUploadVexRequest) Execute() (*http.Response, error) {
...
func (r ApiUploadVex1Request) Execute() (*http.Response, error) {
