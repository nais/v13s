...
func (r ApiGetLicenseGroupsRequest) PageNumber(pageNumber interface{}) ApiGetLicenseGroupsRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetLicenseGroupsRequest) PageSize(pageSize interface{}) ApiGetLicenseGroupsRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetLicenseGroupsRequest) Offset(offset interface{}) ApiGetLicenseGroupsRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetLicenseGroupsRequest) Limit(limit interface{}) ApiGetLicenseGroupsRequest {
	r.limit = &limit
	return r
}
