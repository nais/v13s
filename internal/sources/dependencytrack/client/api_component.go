...
func (r ApiGetAllComponentsRequest) PageNumber(pageNumber interface{}) ApiGetAllComponentsRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetAllComponentsRequest) PageSize(pageSize interface{}) ApiGetAllComponentsRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetAllComponentsRequest) Offset(offset interface{}) ApiGetAllComponentsRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetAllComponentsRequest) Limit(limit interface{}) ApiGetAllComponentsRequest {
	r.limit = &limit
	return r
}
...
// The page to return. To be used in conjunction with &lt;code&gt;pageSize&lt;/code&gt;.
func (r ApiGetComponentByHashRequest) PageNumber(pageNumber interface{}) ApiGetComponentByHashRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetComponentByHashRequest) PageSize(pageSize interface{}) ApiGetComponentByHashRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetComponentByHashRequest) Offset(offset interface{}) ApiGetComponentByHashRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetComponentByHashRequest) Limit(limit interface{}) ApiGetComponentByHashRequest {
	r.limit = &limit
	return r
}
...
// The page to return. To be used in conjunction with &lt;code&gt;pageSize&lt;/code&gt;.
func (r ApiGetComponentByIdentityRequest) PageNumber(pageNumber interface{}) ApiGetComponentByIdentityRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetComponentByIdentityRequest) PageSize(pageSize interface{}) ApiGetComponentByIdentityRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetComponentByIdentityRequest) Offset(offset interface{}) ApiGetComponentByIdentityRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetComponentByIdentityRequest) Limit(limit interface{}) ApiGetComponentByIdentityRequest {
	r.limit = &limit
	return r
}
...
func (r ApiGetDependencyGraphForComponentRequest) Execute() (*map[string]Component, *http.Response, error) {
