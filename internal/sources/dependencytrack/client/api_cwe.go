...
func (r ApiGetCwesRequest) PageNumber(pageNumber interface{}) ApiGetCwesRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetCwesRequest) PageSize(pageSize interface{}) ApiGetCwesRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetCwesRequest) Offset(offset interface{}) ApiGetCwesRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetCwesRequest) Limit(limit interface{}) ApiGetCwesRequest {
	r.limit = &limit
	return r
}
