...
type NotificationAPI interface {
	...
	*/
	...
	//  @return NotificationRule
	UpdateNotificationPublisherExecute(r ApiUpdateNotificationPublisherRequest) (*NotificationRule, *http.Response, error)
...
func (r ApiDeleteNotificationRuleRequest) Body(body NotificationRule) ApiDeleteNotificationRuleRequest {
	r.body = &body
	return r
}
...
func (r ApiGetAllNotificationRulesRequest) PageNumber(pageNumber interface{}) ApiGetAllNotificationRulesRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetAllNotificationRulesRequest) PageSize(pageSize interface{}) ApiGetAllNotificationRulesRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetAllNotificationRulesRequest) Offset(offset interface{}) ApiGetAllNotificationRulesRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetAllNotificationRulesRequest) Limit(limit interface{}) ApiGetAllNotificationRulesRequest {
	r.limit = &limit
	return r
}
...
func (r ApiUpdateNotificationPublisherRequest) Execute() (*NotificationRule, *http.Response, error) {
...
// Execute executes the request
//  @return NotificationRule
func (a *NotificationAPIService) UpdateNotificationPublisherExecute(r ApiUpdateNotificationPublisherRequest) (*NotificationRule, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdateNotificationRuleRequest) Body(body NotificationRule) ApiUpdateNotificationRuleRequest {
	r.body = &body
	return r
}
