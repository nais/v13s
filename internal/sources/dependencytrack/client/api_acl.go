...
func (r ApiRetrieveProjectsRequest) PageNumber(pageNumber interface{}) ApiRetrieveProjectsRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiRetrieveProjectsRequest) PageSize(pageSize interface{}) ApiRetrieveProjectsRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiRetrieveProjectsRequest) Offset(offset interface{}) ApiRetrieveProjectsRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiRetrieveProjectsRequest) Limit(limit interface{}) ApiRetrieveProjectsRequest {
	r.limit = &limit
	return r
}
...
func (r ApiRetrieveProjectsRequest) Execute() ([]string, *http.Response, error) {
