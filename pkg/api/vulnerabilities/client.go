...
type Client interface {
	...
	GetSbom(ctx context.Context, opts ...Option) (*GetSbomResponse, error)
...
func (c *client) GetSbom(ctx context.Context, opts ...Option) (*GetSbomResponse, error) {
	o := applyOptions(opts...)
	return c.v.GetSbom(ctx, &GetSbomRequest{
		Filter: o.Filter,
	})
}
