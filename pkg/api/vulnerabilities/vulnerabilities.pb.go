...
type Summary struct {
	...
	StaleSummary  bool                   `protobuf:"varint,10,opt,name=stale_summary,json=staleSummary,proto3" json:"stale_summary,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Summary) GetStaleSummary() bool {
	if x != nil {
...
const file_vulnerabilities_proto_rawDesc = "" +
	...
	"\timage_tag\x18\x06 \x01(\tR\bimageTag\"\xcb\x02\n" +
	"\aSummary\x12\x1a\n" +
