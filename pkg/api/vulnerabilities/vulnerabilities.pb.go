...
type ListVulnerabilitiesResponse struct {
	state           protoimpl.MessageState           `protogen:"open.v1"`
	Filter          *Filter                          `protobuf:"bytes,1,opt,name=filter,proto3" json:"filter,omitempty"`
	Vulnerabilities []*WorkloadVulnerabilityFindings `protobuf:"bytes,2,rep,name=vulnerabilities,proto3" json:"vulnerabilities,omitempty"`
...
func (x *ListVulnerabilitiesResponse) GetVulnerabilities() []*WorkloadVulnerabilityFindings {
	if x != nil {
...
type WorkloadVulnerabilityFindings struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Workload      *Workload              `protobuf:"bytes,1,opt,name=workload,proto3" json:"workload,omitempty"`
	Findings      []*Vulnerability       `protobuf:"bytes,2,rep,name=findings,proto3" json:"findings,omitempty"`
...
func (x *WorkloadVulnerabilityFindings) Reset() {
	*x = WorkloadVulnerabilityFindings{}
	mi := &file_vulnerabilities_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WorkloadVulnerabilityFindings) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkloadVulnerabilityFindings) ProtoMessage() {}

func (x *WorkloadVulnerabilityFindings) ProtoReflect() protoreflect.Message {
	mi := &file_vulnerabilities_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkloadVulnerabilityFindings.ProtoReflect.Descriptor instead.
func (*WorkloadVulnerabilityFindings) Descriptor() ([]byte, []int) {
	return file_vulnerabilities_proto_rawDescGZIP(), []int{12}
}

func (x *WorkloadVulnerabilityFindings) GetWorkload() *Workload {
	if x != nil {
		return x.Workload
	}
	return nil
...
func (x *WorkloadVulnerabilityFindings) GetFindings() []*Vulnerability {
	if x != nil {
		return x.Findings
	}
	return nil
...
func (x *WorkloadVulnerabilityFindings) GetLastUpdated() *timestamppb.Timestamp {
	if x != nil {
		return x.LastUpdated
	}
	return nil
...
var file_vulnerabilities_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x70, 0x70, 0x72, 0x65, 0x73, 0x73, 0x65, 0x64, 0x22, 0xb0, 0x01, 0x0a, 0x1b, 0x4c,
	...
	,
	...
	0x22, 0xf6, 0x01, 0x0a, 0x07, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x12, 0x1a, 0x0a, 0x08,
	...
	0x63, 0x6f, 0x72, 0x65, 0x12, 0x42, 0x0a, 0x0c, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x75, 0x70, 0x64,
	...
	0x74, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x22, 0xc7, 0x01, 0x0a, 0x1f, 0x47, 0x65,
	0x74, 0x56, 0x75, 0x6c, 0x6e, 0x65, 0x72, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x53, 0x75,
	...
	0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x48, 0x00, 0x52, 0x14, 0x76, 0x75, 0x6c, 0x6e, 0x65,
	0x72, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x88,
	0x01, 0x01, 0x12, 0x25, 0x0a, 0x0e, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x77, 0x6f, 0x72, 0x6b,
	0x6c, 0x6f, 0x61, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x18, 0x0a, 0x16, 0x5f, 0x76, 0x75,
	0x6c, 0x6e, 0x65, 0x72, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x5f, 0x73, 0x75, 0x6d, 0x6d,
	0x61, 0x72, 0x79, 0x22, 0x80, 0x01, 0x0a, 0x08, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64,
	...
	0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x22, 0x88, 0x01, 0x0a, 0x03, 0x43, 0x77, 0x65, 0x12, 0x0e,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6c, 0x69, 0x6e, 0x6b, 0x12, 0x25, 0x0a, 0x08, 0x73, 0x65,
	0x76, 0x65, 0x72, 0x69, 0x74, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x09, 0x2e, 0x53,
	0x65, 0x76, 0x65, 0x72, 0x69, 0x74, 0x79, 0x52, 0x08, 0x73, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74,
	0x79, 0x22, 0x75, 0x0a, 0x0d, 0x56, 0x75, 0x6c, 0x6e, 0x65, 0x72, 0x61, 0x62, 0x69, 0x6c, 0x69,
	...
	,
	...
	0x65, 0x64, 0x2a, 0x47, 0x0a, 0x08, 0x53, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74, 0x79, 0x12, 0x0c,
	...
	0x4e, 0x41, 0x53, 0x53, 0x49, 0x47, 0x4e, 0x45, 0x44, 0x10, 0x04, 0x32, 0xa8, 0x02, 0x0a, 0x0f,
	0x56, 0x75, 0x6c, 0x6e, 0x65, 0x72, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12,
	0x65, 0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74, 0x56, 0x75, 0x6c, 0x6e, 0x65, 0x72, 0x61, 0x62, 0x69,
	0x6c, 0x69, 0x74, 0x79, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x69, 0x65, 0x73, 0x12, 0x22, 0x2e,
	...
	,
...
var file_vulnerabilities_proto_goTypes = []any{
	...
	(*WorkloadVulnerabilityFindings)(nil),      // 13: WorkloadVulnerabilityFindings
...
var file_vulnerabilities_proto_depIdxs = []int32{
	...
	13, // 7: ListVulnerabilitiesResponse.vulnerabilities:type_name -> WorkloadVulnerabilityFindings
	...
	11, // 14: Vulnerability.cwe:type_name -> Cwe
	10, // 15: WorkloadVulnerabilityFindings.workload:type_name -> Workload
	12, // 16: WorkloadVulnerabilityFindings.findings:type_name -> Vulnerability
	15, // 17: WorkloadVulnerabilityFindings.last_updated:type_name -> google.protobuf.Timestamp
	3,  // 18: Vulnerabilities.ListVulnerabilitySummaries:input_type -> ListVulnerabilitySummariesRequest
	5,  // 19: Vulnerabilities.ListVulnerabilities:input_type -> ListVulnerabilitiesRequest
	7,  // 20: Vulnerabilities.GetVulnerabilitySummary:input_type -> GetVulnerabilitySummaryRequest
	4,  // 21: Vulnerabilities.ListVulnerabilitySummaries:output_type -> ListVulnerabilitySummariesResponse
	6,  // 22: Vulnerabilities.ListVulnerabilities:output_type -> ListVulnerabilitiesResponse
